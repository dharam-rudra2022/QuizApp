...
import { Icon } from 'react-native-elements';
 ...
 const styles=StyleSheet.create({
     ...
     textstyle:{padding:15,fontSize:15,color:'green'},
     bottomview:{padding:13,backgroundColor:'green',borderRadius:300,width:70,height:70,position:'absolute',right:20,top:550},
