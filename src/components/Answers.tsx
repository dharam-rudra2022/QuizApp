...
import { AnswerObject } from '../screens/Dashboard';
 ...
 const styles=StyleSheet.create({
    questioncontainer:{flexDirection:'row',alignItems:'center',backgroundColor:'white',
    marginTop:10,paddingRight:16},
     
    textstyle:{padding:15,fontSize:15,color:'yellow'},
 })
